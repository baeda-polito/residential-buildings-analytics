...
def run_user_classification(aggregate: Aggregate):
    """
    ...
    joblib.dump(model_consumer,
                os.path.join(PROJECT_ROOT, "results", "benchmarking", "models", f"model_consumer{aggregate.name}.pkl"))
    ...
    joblib.dump(model_prosumer,
                os.path.join(PROJECT_ROOT, "data", "benchmarking", "models", f"model_prosumer_{aggregate.name}.pkl"))
