...
plt.savefig(os.path.join(PROJECT_ROOT, "figures", "aggregate_anguillara.png"))
plt.show()
...
plt.savefig(os.path.join(PROJECT_ROOT, "figures", "aggregate", "stacked_area_plot_anguillara.png"))
plt.show()
plt.close(fig)
